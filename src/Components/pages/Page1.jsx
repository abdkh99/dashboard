...
return (
  <>
    ...
    <div className=" wrapper  text-center lg:mx-4 text-black grid gap-5 grid-cols-3  max-xl:grid-cols-1 max-xl:gap-4   ">
      <div className="welcome box-shadow rounded-md shadow-xl min-sm:ml-4  bg-white  relative overflow-hidden card">
        <div className="intro  flex relative bg-[#eee] w-full p-5 justify-between">
          ...
          <img
            className="h-2020b-[-2px] w-30 p-1 m-4 max-sm:invisible "
            src={welcome}
            alt="no image"
          />
        </div>
      ...
      <div className="quic-draft p-5 h-full card box-shadow rounded-md shadow-xl min-sm:ml-4  bg-white  relative overflow-hidden ">
        ...
        <p className="text-gray-400 mt-0 mb-10">Write A Draft For Your Ideas</p>
        <form action="">
          <input
      ...
      <div className="latest-news card p-10 bg-white text-start  rounded-xl max-sm:text-center">
        <h2 className="font-bold text-2xl text-black pb-5 mb-2">Latest News</h2>
        <div className="news-row hover:bg-gray-50 flex items-center gap-1 mb-2 pb-4 border-b border-gray-200 max-sm:block ">
          ...
          <div className="info flex-1 ">
            <h3 className="m-0 mb-2 font-bold text-xl">Created SASS Section</h3>
            <p className="m-0 text-gray-400">New SASS Examples And Tutorial</p>
          </div>
      ...
      <div className="latest-uploads card p-10 bg-white rounded-lg ">
        ...
        <ul className="m-0">
          <li className="flex justify-between items-center pb-4 mb-2 border-b border-gray-400">
            <div className="flex items-center">
              ...
              <div>
                ...
                <span className="block text-start text-gray-500">Abdullah</span>
              </div>
            </div>
            <div className="border bg-gray-200 w-fit p-2 rounded-lg">2.9mb</div>
          </li>
          <li className="flex justify-between items-center pb-5 mb-2 border-b border-gray-400">
            ...
            <div className="border bg-gray-200 w-fit p-2 rounded-lg">4.9mb</div>
          </li>
          <li className="flex justify-between items-center pb-5 mb-2 border-b border-gray-400">
            <div className="flex items-center">
              <img
          ...
          <li className="flex justify-between items-center pb-5 mb-2 border-b border-gray-400">
            ...
            <div className="border bg-gray-200 w-fit p-2 rounded-lg">5.2mb</div>
          </li>
          <li className="flex justify-between items-center pb-5 mb-2 border-b border-gray-400">
            <div className="flex items-center">
              <img
            ...
            <div className="border bg-gray-200 w-fit p-2 rounded-lg">7.2mb</div>
          </li>
          <li className="flex justify-between items-center pb-5 mb-2 border-b border-gray-400">
            <div className="flex items-center">
              <img
              ...
              <div>
                ...
                <span className="block text-start text-gray-500">Designer</span>
              </div>
            </div>
            <div className="border bg-gray-200 w-fit p-2 rounded-lg">2.9mb</div>
          </li>
      ...
      <div className="reminders card p-10 bg-white rounded-lg relative">
        <h2 className="mt-0 mb-10 text-start font-bold text-2xl">Reminders</h2>
        <ul className="m-0">
          ...
          <div className="Social-row group flex justify-between relative items-center mb-1 border pl-0 p-5 rounded-lg max-h-20 overflow-hidden bg-gradient-to-tr from-[#c13584b5] to-[#833ab4dc]">
            <div className="flex justify-between  items-center">
              <FontAwesomeIcon
                ...
                icon={faInstagram}
              />
              <span className="font-bold text-[#802495]"> 90K Followers </span>
            </div>
